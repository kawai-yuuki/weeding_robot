...
#include <stddef.h>
#include "my_robot_interfaces/msg/detail/sensor__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  my_robot_interfaces__msg__Sensor__init(message_memory);
}

void Sensor__rosidl_typesupport_introspection_c__Sensor_fini_function(void * message_memory)
{
  my_robot_interfaces__msg__Sensor__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Sensor__rosidl_typesupport_introspection_c__Sensor_message_member_array[2] = {
  {
    ...
    offsetof(my_robot_interfaces__msg__Sensor, front_sensor_data),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces__msg__Sensor, rear_sensor_data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Sensor__rosidl_typesupport_introspection_c__Sensor_message_members = {
  ...
  "Sensor",  // message name
  2,  // number of fields
  sizeof(my_robot_interfaces__msg__Sensor),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, msg, Sensor)() {
