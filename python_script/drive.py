...
pi.set_PWM_dutycycle(MOT_R_1, 0)   	#MOT_R_1:20/100
pi.set_PWM_dutycycle(MOT_R_2, 20)    	#MOT_R_2:0/100
pi.set_PWM_dutycycle(MOT_L_1, 0)   	#MOT_L_1:20/100
pi.set_PWM_dutycycle(MOT_L_2, 20)    	#MOT_L_2:0/100

DURATION = 0.01		#制御周期（秒）
